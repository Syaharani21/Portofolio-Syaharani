...
const Masonry = ({
  ...
  useLayoutEffect(() => {
    ...
    // ensure the container has the correct height so absolutely positioned
    // items are visible (parent may not have an intrinsic height)
    const containerHeight = grid.reduce(
